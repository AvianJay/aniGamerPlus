...
- **繼續觀看** —— 首頁那一排也包含片庫裡沒有的作品 (線上看過、還沒下載的). 播放頁會把
  官方集數表寫進瀏覽器的一份名稱表 (`agp-watch-names`), 首頁與作品資訊讀同一份, 所以
  不必先開紀錄頁就認得出來; 作品資訊那一張也會顯示「看到第 N 集」、進度條與繼續觀看鍵
